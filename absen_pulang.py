...
def absen_pulang(driver, username, password, nama_sekolah):
    ...
    try:
        ...
        time.sleep(1)
        absen_pulang_button = driver.find_element(By.XPATH, '//*[@id="app"]/div/main/div/div[2]/div/div[2]/div[1]/div/div/div[1]/button[2]/span')
        absen_pulang_button.click()
        print("Tombol absen pulang berhasil diklik!")
        time.sleep(10)
    except Exception as e:
        print(f"Error saat menekan tombol absen pulang: {e}")

# Menjalankan absensi
driver = setup_driver()
absen_pulang(driver, username, password, nama_sekolah)
